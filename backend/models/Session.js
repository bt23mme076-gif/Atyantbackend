...
const sessionSchema = new mongoose.Schema({
  ...
  sessionType: { type: String, enum: ['chat', 'voice', 'video', 'resume'], default: 'chat' },
  ...
  // ── Text Q&A chat lifecycle (only meaningful for serviceId === 'text-qa') ──
  // chatKickoffSent: the mentor's first automated "ask your doubt" message has
  //   been created for this purchase (prevents duplicates across verify/webhook).
  // chatResolved:    the mentor marked the conversation resolved after answering.
  chatKickoffSent: { type: Boolean, default: false },
  chatMentorEmailSent: { type: Boolean, default: false },
  chatStudentEmailSent: { type: Boolean, default: false },
  chatResolved: { type: Boolean, default: false },
  chatResolvedAt: { type: Date, default: null },
